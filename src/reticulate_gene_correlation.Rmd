...
```{r}
output_dir <-  "output/gene_corr_with_ptime/"
```



```{r, eval = T}
source_python("genes_correlated_with_pseudotime2.py")

```

```{python, echo = F}
from genes_correlated_with_pseudotime2 import *
```
...
```{r}
pseudotime_files = "resources/input/FACS_0407_2017_SHL_input_files/733_PC4-5"

ctrl_pseudotime_files = "resources/input/FACS_0407_2017_SHL_input_files/737_PC1-4"
